          ...
          <div className="hidden md:flex items-center gap-8">
            {NAV_LINKS.map(({ label, href, target, rel, pill }) => (
              <a
                ...
                className={
                  pill
                    ? `text-xs uppercase tracking-widest transition-colors duration-200 rounded-full px-3 py-1.5 border ${
                        navIsDark
                    ...
                    : `text-xs uppercase tracking-widest transition-colors duration-700 ${
                        navIsDark
